export const projects = [
  ...
  {
    title: "ASAY - School Management System",
    description1:
...
export const TimeLineData = [
  { year: 1997, text: "👶🏻 Started my journey" },
  { year: 2014, text: "👨🏻‍🎓 Finished secondary education" },
  { year: 2015, text: "🏛️ Entered to Business School at UCN(Universidad Católica Del Norte)" },
  { year: 2018, text: "🎯 Drop out to pursue my true passion, Technology and Music" },
  { year: 2019, text: "💻 Entered to Software Engineering at Technological University of Chile INACAP" },
  { year: 2022, text: "👨🏻‍🎓 Got Graduated as Software Engineer" },
  { year: 2023, text: "👨🏻‍💻 Started My Internship Program to get my Engineering Degree" },
];
